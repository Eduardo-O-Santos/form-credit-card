...
// Observa o campo Input name
const cardHolder = document.querySelector("#card-holder");

cardHolder.addEventListener("input", () => {
  const ccNameValue = document.querySelector(".cc-holder .value");
  ccNameValue.innerText = cardHolder.value.length === 0 ? "FULANO DA SILVA" : cardHolder.value;
});
